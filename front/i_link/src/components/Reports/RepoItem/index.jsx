  ...
  return (
    <Card sx={{ mt: 2, mx: 3, height: 250, width: 250, display: "flex", flexDirection: "column"}}>
      <CardContent sx={{ flexGrow: 1 }}>
        {/* 등하원 */}
        {types[report_type] === '등하원' && (<Typography
          sx={{ fontSize: 14, maxWidth:'80px', textAlign:'center', borderRadius:'10px' }}
        ...
        {/* 교우관계 */}
        {types[report_type] === '교우관계' && (<Typography
          sx={{ fontSize: 14, maxWidth:'80px', textAlign:'center', borderRadius:'10px' }}
          color="text.secondary"
          id="font_test"
          gutterBottom
        ...
        {/* 알레르기(음식) */}
        {types[report_type] === '알레르기(음식)' && (<Typography
          sx={{ fontSize: 14, maxWidth:'110px', textAlign:'center', borderRadius:'10px' }}
          color="text.secondary"
          id="font_test"
          gutterBottom
          bgcolor="#edffd9"
        ...
        {/* 약복용 */}
        {types[report_type] === '약복용' && (<Typography
          sx={{ fontSize: 14, maxWidth:'80px', textAlign:'center', borderRadius:'10px' }}
          color="text.secondary"
          id="font_test"
          gutterBottom
        ...
        {/* 수면 */}
        {types[report_type] === '수면' && (<Typography
          sx={{ fontSize: 14, maxWidth:'80px', textAlign:'center', borderRadius:'10px' }}
          color="text.secondary"
          id="font_test"
          gutterBottom
        ...
        {/* 기타 */}
        {types[report_type] === '기타' && (<Typography
          sx={{ fontSize: 14, maxWidth:'80px', textAlign:'center', borderRadius:'10px' }}
          color="text.secondary"
          id="font_test"
          gutterBottom
        ...
        <Typography variant="body2" component="div" id="font_test" color="text.secondary" sx={{ textAlign:"right"}}>
          {repoDate}
        </Typography>
